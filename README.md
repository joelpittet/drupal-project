...
[![Build Status](https://travis-ci.org/joelpittet/drupal-project.svg?branch=8.x)](https://travis-ci.org/joelpittet/drupal-project)
...
```
composer create-project joelpittet/drupal-project:8.x-dev some-dir --stability dev --no-interaction
```
